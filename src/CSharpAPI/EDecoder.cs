...
#warning TODO: implement call to start api in client
        ...
        public decimal ReadDecimal()
        {
                ...
                decimalAsstring == "0")
            {
                ...
                return Decimal.Parse(decimalAsstring, System.Globalization.NumberFormatInfo.InvariantInfo);
        }
        ...
        public decimal ReadDecimalMax()
        {
            ...
            if (str == null || str.Length == 0)
                ...
                return Decimal.Parse(str, System.Globalization.NumberFormatInfo.InvariantInfo);
        }
