...
namespace IBApi
{
    ...
    public abstract class EClient
    {
        ...
        */
         ...
         */
        public void calculateImpliedVolatility(int reqId, Contract contract, decimal optionPrice, decimal underPrice, List<TagValue> impliedVolatilityOptions)
        {
            if (!CheckConnection())
                return;
         ...
         */
        public void calculateOptionPrice(int reqId, Contract contract, decimal volatility, decimal underPrice, List<TagValue> optionPriceOptions)
        {
            if (!CheckConnection())
                return;
        ...
        public void placeOrder(int id, Contract contract, Order order)
        {
            ...
            {
                paramsList.AddParameter(order.LmtPrice == Decimal.MaxValue ? 0m : order.LmtPrice);
            }
            else
            {
            ...
            {
                paramsList.AddParameter(order.AuxPrice == Decimal.MaxValue ? 0m : order.AuxPrice);
            }
            else
            {
        ...
        protected bool VerifyOrder(Order order, int id, bool isBagOrder)
        {
            ...
            {
                if (order.ScalePriceIncrement > 0m && order.ScalePriceIncrement != Decimal.MaxValue)
                {
