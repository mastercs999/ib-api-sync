...
namespace IBApi
{
    ...
    public interface EWrapper
    {
         ...
         */
        void tickPrice(int tickerId, int field, decimal price, int canAutoExecute);
        ...
        void updatePortfolio(Contract contract, decimal position, decimal marketPrice, decimal marketValue,
            decimal averageCost, decimal unrealisedPNL, decimal realisedPNL, string accountName);
         ...
         */
        void historicalData(int reqId, string date, decimal open, decimal high, decimal low, decimal close, int volume, int count, decimal WAP, bool hasGaps);
        ...
        */
         ...
         */
        void updateMktDepthL2(int tickerId, int position, string marketMaker, int operation, int side, decimal price, int size);
         ...
         */
        void realtimeBar(int reqId, long time, decimal open, decimal high, decimal low, decimal close, long volume, decimal WAP, int count);
